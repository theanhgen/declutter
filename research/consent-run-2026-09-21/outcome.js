(async () => {
  ...
  for (const e of all) {
    ...
    if ((cs.position === 'fixed' || cs.position === 'sticky') && e.offsetHeight > 40 && cs.display !== 'none' && cs.visibility !== 'hidden' && cs.opacity !== '0') {
      ...
      if (/cookie|souhlas|soukromí|personaliz|consent|reklam/i.test(t) && t.length < 5000) banners.push(`${e.tagName.toLowerCase()}#${e.id}.${String(e.className).slice(0, 40)} :: ${t.slice(0, 90)}`);
    }
